            ...
            <transition enter-active-class="transition ease-out duration-500" enter-from-class="opacity-0 translate-y-5" enter-to-class="opacity-100 translate-y-0" >
                <div v-show="showForm" class="max-w-xs lg:max-w-6xl w-full flex flex-col md:flex-row items-center md:items-center text-white gap-10">
                    ...
                    <div class="w-full md:w-1/2 bg-white text-primary rounded-2xl shadow-md p-8">
                        <!-- General status -->
                        <transition enter-active-class="transition ease-out duration-500" enter-from-class="opacity-0 scale-x-0" enter-to-class="opacity-100 scale-x-100" >
                        ...
                        <form @submit.prevent="submit">
                            <div class="space-y-4">
                                ...
                                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mt-4">
                                    ...
                                    <Link v-if="canResetPassword" :href="route('password.request')" class="mt-2 sm:mt-0 text-sm text-primary hover:underline hover:text-lightPrimary focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2">
